...
function() {
	...
	window.Swiper = function(e, a) {
		...
		function s(e, t) {
			var a = h(e.target);
			if (!a.is(t)) if ("string" == typeof t) a = a.parents(t);
			else if (t.nodeType) {
				var r;
		...
		function o(e) {
			...
			if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
				if (37 === t || 39 === t || 38 === t || 40 === t) {
					...
					}, s = window.innerWidth, n = window.innerHeight, o = f.container.offset(), l = [
						[o.left, o.top],
		...
		function l(e) {
			...
			else if ("mousewheel" === t) if (f.params.mousewheelForceToAxis) if (r()) {
			...
			else if ("wheel" === t) if (f.params.mousewheelForceToAxis) if (r()) {
			...
			} else(new Date).getTime() - f._lastWheelScrollTime > 60 && (0 > a ? f.slideNext() : f.slidePrev()), f._lastWheelScrollTime = (new Date).getTime();
			return f.params.autoplay && f.stopAutoplay(), e.preventDefault ? e.preventDefault() : e.returnValue = !1, !1
		}
		function d(e, t) {
			e = h(e);
			var a, i, s;
			a = e.attr("data-swiper-parallax") || "0", i = e.attr("data-swiper-parallax-x"), s = e.attr("data-swiper-parallax-y"), i || s ? (i = i || "0", s = s || "0") : r() ? (i = a, s = "0") : (s = a, i = "0"), i = i.indexOf("%") >= 0 ? parseInt(i, 10) * t + "%" : i * t + "px", s = s.indexOf("%") >= 0 ? parseInt(s, 10) * t + "%" : s * t + "px", e.transform("translate3d(" + i + ", " + s + ",0px)")
		}
		function p(e) {
		...
		a = a || {};
		for (var c in u) if ("undefined" == typeof a[c]) a[c] = u[c];
		else if ("object" == typeof a[c]) for (var m in u[c])"undefined" == typeof a[c][m] && (a[c][m] = u[c][m]);
		var f = this;
		f.params = a, f.classNames = [];
		var h;
		if (h = "undefined" == typeof t ? window.Dom7 || window.Zepto || window.jQuery : t, h && (f.$ = h, f.container = h(e), 0 !== f.container.length)) {
			...
			f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push("swiper-container-" + f.params.direction), f.params.freeMode && f.classNames.push("swiper-container-free-mode"), f.support.flexbox || (f.classNames.push("swiper-container-no-flexbox"), f.params.slidesPerColumn = 1), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push("swiper-container-3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push("swiper-container-" + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0, f.params.setWrapperSize = !1), "fade" === f.params.effect && (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, f.params.virtualTranslate = !0), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = h(f.params.pagination), f.params.paginationClickable && f.paginationContainer.addClass("swiper-pagination-clickable")), f.rtl = r() && ("rtl" === f.container[0].dir.toLowerCase() || "rtl" === f.container.css("direction")), f.rtl && f.classNames.push("swiper-container-rtl"), f.rtl && (f.wrongRTL = "-webkit-box" === f.wrapper.css("display")), f.params.slidesPerColumn > 1 && f.classNames.push("swiper-container-multirow"), f.device.android && f.classNames.push("swiper-container-android"), f.container.addClass(f.classNames.join(" ")), f.translate = 0, f.progress = 0, f.velocity = 0, f.lockSwipeToNext = function() {
			...
			}, f.params.grabCursor && (f.container[0].style.cursor = "move", f.container[0].style.cursor = "-webkit-grab", f.container[0].style.cursor = "-moz-grab", f.container[0].style.cursor = "grab"), f.imagesToLoad = [], f.imagesLoaded = 0, f.loadImage = function(e, t, a, r) {
				function i() {
					r && r()
				}
				var s;
				e.complete && a ? i() : t ? (s = new Image, s.onload = i, s.onerror = i, s.src = t) : i()
				...
				var e, t = f.params.spaceBetween,
					...
					i = 0,
					s = 0;
				"string" == typeof t && t.indexOf("%") >= 0 && (t = parseFloat(t.replace("%", "")) / 100 * f.size), f.virtualSize = -t, f.slides.css(f.rtl ? {
					marginLeft: "",
					marginTop: ""
				} : {
					marginRight: "",
				...
				for (e = 0; e < f.slides.length; e++) {
					...
					if (f.params.slidesPerColumn > 1) {
						var d, p, u, c, m = f.params.slidesPerColumn;
						"column" === f.params.slidesPerColumnFill ? (p = Math.floor(e / m), u = e - p * m, d = p + u * n / m, l.css({
				...
				}), (!f.support.flexbox || f.params.setWrapperSize) && f.wrapper.css(r() ? {
					width: f.virtualSize + f.params.spaceBetween + "px"
				} : {
				...
				if ("undefined" == typeof e && (e = f.translate || 0), 0 !== f.slides.length) {
					...
					f.rtl && (t = f.params.centeredSlides ? e - f.size / 2 : e); {
						f.container[0].getBoundingClientRect(), r() ? "left" : "top", r() ? "right" : "bottom"
					}
					...
					for (var a = 0; a < f.slides.length; a++) {
						var i = f.slides[a],
							...
							n = (t - i.swiperSlideOffset - s) / (i.swiperSlideSize + f.params.spaceBetween);
						if (f.params.watchSlidesVisibility) {
							var o = -(t - i.swiperSlideOffset - s),
								l = o + f.slidesSizesGrid[a],
								d = o >= 0 && o < f.size || l > 0 && l <= f.size || 0 >= o && l >= f.size;
				...
				0 === t ? (f.progress = 0, f.isBeginning = f.isEnd = !0) : (f.progress = (e - f.minTranslate()) / t, f.isBeginning = f.progress <= 0, f.isEnd = f.progress >= 1), f.isBeginning && f.emit("onReachBeginning", f), f.isEnd && f.emit("onReachEnd", f), f.params.watchSlidesProgress && f.updateSlidesProgress(e), f.emit("onProgress", f, f.progress)
			}, f.updateActiveIndex = function() {
				var e, t, a, r = f.rtl ? f.translate : -f.translate;
				for (t = 0; t < f.slidesGrid.length; t++)"undefined" != typeof f.slidesGrid[t + 1] ? r >= f.slidesGrid[t] && r < f.slidesGrid[t + 1] - (f.slidesGrid[t + 1] - f.slidesGrid[t]) / 2 ? e = t : r >= f.slidesGrid[t] && r < f.slidesGrid[t + 1] && (e = t + 1) : r >= f.slidesGrid[t] && (e = t);
				(0 > e || "undefined" == typeof e) && (e = 0), a = Math.floor(e / f.params.slidesPerGroup), a >= f.snapGrid.length && (a = f.snapGrid.length - 1), e !== f.activeIndex && (f.snapIndex = a, f.previousIndex = f.activeIndex, f.activeIndex = e, f.updateClasses())
				...
				if (e.addClass(f.params.slideActiveClass), e.next("." + f.params.slideClass).addClass(f.params.slideNextClass), e.prev("." + f.params.slideClass).addClass(f.params.slidePrevClass), f.bullets && f.bullets.length > 0) {
					...
					var t;
					f.params.loop ? (t = Math.ceil(f.activeIndex - f.loopedSlides) / f.params.slidesPerGroup, t > f.slides.length - 1 - 2 * f.loopedSlides && (t -= f.slides.length - 2 * f.loopedSlides), t > f.bullets.length - 1 && (t -= f.bullets.length)) : t = "undefined" != typeof f.snapIndex ? f.snapIndex : f.activeIndex || 0, f.paginationContainer.length > 1 ? f.bullets.each(function() {
						h(this).index() === t && h(this).addClass(f.params.bulletActiveClass)
				...
				if (f.params.pagination && f.paginationContainer && f.paginationContainer.length > 0) {
					for (var e = "", t = f.params.loop ? Math.ceil((f.slides.length - 2 * f.loopedSlides) / f.params.slidesPerGroup) : f.snapGrid.length, a = 0; t > a; a++) e += f.params.paginationBulletRender ? f.params.paginationBulletRender(a, f.params.bulletClass) : '<span class="' + f.params.bulletClass + '"></span>';
					f.paginationContainer.html(e), f.bullets = f.paginationContainer.find("." + f.params.bulletClass)
				}
			}, f.update = function(e) {
				function t() {
					r = Math.min(Math.max(f.translate, f.maxTranslate()), f.minTranslate()), f.setWrapperTranslate(r), f.updateActiveIndex(), f.updateClasses()
				}
				if (f.updateContainerSize(), f.updateSlidesSize(), f.updateProgress(), f.updatePagination(), f.updateClasses(), f.params.scrollbar && f.scrollbar && f.scrollbar.set(), e) {
					var a, r;
					f.params.freeMode ? t() : (a = "auto" === f.params.slidesPerView && f.isEnd && !f.params.centeredSlides ? f.slideTo(f.slides.length - 1, 0, !1, !0) : f.slideTo(f.activeIndex, 0, !1, !0), a || t())
				}
			}, f.onResize = function() {
			...
			window.navigator.pointerEnabled ? g = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (g = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), f.touchEvents = {
				start: f.support.touch || !f.params.simulateTouch ? "touchstart" : g[0],
				...
				if (f.clickedSlide = t, f.clickedIndex = h(t).index(), f.params.slideToClickedSlide && void 0 !== f.clickedIndex && f.clickedIndex !== f.activeIndex) {
					var a, r = f.clickedIndex;
					if (f.params.loop) if (a = h(f.clickedSlide).attr("data-swiper-slide-index"), r > f.slides.length - f.params.slidesPerView) f.fixLoop(), r = f.wrapper.children("." + f.params.slideClass + '[data-swiper-slide-index="' + a + '"]').eq(0).index(), setTimeout(function() {
						f.slideTo(r)
					}, 0);
					else if (r < f.params.slidesPerView - 1) {
						f.fixLoop();
						var i = f.wrapper.children("." + f.params.slideClass + '[data-swiper-slide-index="' + a + '"]');
			...
			var v, w, y, b, T, x, S, C, M, E = "input, select, textarea, button",
				z = Date.now(),
				P = [];
			...
			if (f.onTouchStart = function(e) {
				if (e.originalEvent && (e = e.originalEvent), I = "touchstart" === e.type, I || !("which" in e) || 3 !== e.which) {
					if (f.params.noSwiping && s(e, "." + f.params.noSwipingClass)) return void(f.allowClick = !0);
					if (!f.params.swipeHandler || s(e, f.params.swipeHandler)) {
						if (v = !0, w = !1, b = void 0, k = void 0, f.touches.startX = f.touches.currentX = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, f.touches.startY = f.touches.currentY = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, y = Date.now(), f.allowClick = !0, f.updateContainerSize(), f.swipeDirection = void 0, f.params.threshold > 0 && (S = !1), "touchstart" !== e.type) {
							var t = !0;
				...
				if (e.originalEvent && (e = e.originalEvent), !(I && "mousemove" === e.type || e.preventedByNestedSwiper)) {
					...
					if (I && document.activeElement && e.target === document.activeElement && h(e.target).is(E)) return w = !0, void(f.allowClick = !1);
					if (f.emit("onTouchMove", f, e), !(e.targetTouches && e.targetTouches.length > 1)) {
						if (f.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, f.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, "undefined" == typeof b) {
							...
							b = r() ? t > f.params.touchAngle : 90 - t > f.params.touchAngle
						}
						if (b && f.emit("onTouchMoveOpposite", f, e), "undefined" == typeof k && f.browser.ieTouch && (f.touches.currentX !== f.touches.startX || f.touches.currentY !== f.touches.startY) && (k = !0), v) {
							...
							if (k || !f.browser.ieTouch) {
								...
								i *= f.params.touchRatio, f.rtl && (i = -i), f.swipeDirection = i > 0 ? "prev" : "next", T = i + x;
								var s = !0;
								if (i > 0 && T > f.minTranslate() ? (s = !1, f.params.resistance && (T = f.minTranslate() - 1 + Math.pow(-f.minTranslate() + x + i, f.params.resistanceRatio))) : 0 > i && T < f.maxTranslate() && (s = !1, f.params.resistance && (T = f.maxTranslate() + 1 - Math.pow(f.maxTranslate() - x - i, f.params.resistanceRatio))), s && (e.preventedByNestedSwiper = !0), !f.params.allowSwipeToNext && "next" === f.swipeDirection && x > T && (T = x), !f.params.allowSwipeToPrev && "prev" === f.swipeDirection && T > x && (T = x), f.params.followFinger) {
									if (f.params.threshold > 0) {
										if (!(Math.abs(i) > f.params.threshold || S)) return void(T = x);
										if (!S) return S = !0, f.touches.startX = f.touches.currentX, f.touches.startY = f.touches.currentY, T = x, void(f.touches.diff = r() ? f.touches.currentX - f.touches.startX : f.touches.currentY - f.touches.startY)
				...
				if (e.originalEvent && (e = e.originalEvent), f.emit("onTouchEnd", f, e), v) {
					f.params.grabCursor && w && v && (f.container[0].style.cursor = "move", f.container[0].style.cursor = "-webkit-grab", f.container[0].style.cursor = "-moz-grab", f.container[0].style.cursor = "grab");
					var t = Date.now(),
						a = t - y;
					if (f.allowClick && (f.updateClickedSlide(e), f.emit("onTap", f, e), 300 > a && t - z > 300 && (C && clearTimeout(C), C = setTimeout(function() {
					...
					}, 300)), 300 > a && 300 > t - z && (C && clearTimeout(C), f.emit("onDoubleTap", f, e))), z = Date.now(), setTimeout(function() {
						f && f.allowClick && (f.allowClick = !0)
					}, 0), !v || !w || !f.swipeDirection || 0 === f.touches.diff || T === x) return void(v = w = !1);
					v = w = !1;
					var r;
						...
						if (f.params.freeModeMomentum) {
							if (P.length > 1) {
								var i = P.pop(),
									...
									o = i.time - s.time;
								f.velocity = n / o, f.velocity = f.velocity / 2, Math.abs(f.velocity) < .02 && (f.velocity = 0), (o > 150 || (new Date).getTime() - i.time > 300) && (f.velocity = 0)
							} else f.velocity = 0;
							P.length = 0;
							...
							})) : f.velocity ? (f.updateProgress(p), f.setWrapperTransition(l), f.setWrapperTranslate(p), f.onTransitionStart(), f.animating || (f.animating = !0, f.wrapper.transitionEnd(function() {
								f.onTransitionEnd()
							}))) : f.updateProgress(p), f.updateActiveIndex()
						}
						return void((!f.params.freeModeMomentum || a >= f.params.longSwipesMs) && (f.updateProgress(), f.updateActiveIndex()))
					}
					var g, b = 0,
						S = f.slidesSizesGrid[0];
					for (g = 0; g < f.slidesGrid.length; g += f.params.slidesPerGroup)"undefined" != typeof f.slidesGrid[g + f.params.slidesPerGroup] ? r >= f.slidesGrid[g] && r < f.slidesGrid[g + f.params.slidesPerGroup] && (b = g, S = f.slidesGrid[g + f.params.slidesPerGroup] - f.slidesGrid[g]) : r >= f.slidesGrid[g] && (b = g, S = f.slidesGrid[f.slidesGrid.length - 1] - f.slidesGrid[f.slidesGrid.length - 2]);
					var E = (r - f.slidesGrid[b]) / S;
					if (a > f.params.longSwipesMs) {
						if (!f.params.longSwipes) return void f.slideTo(f.activeIndex);
						"next" === f.swipeDirection && f.slideTo(E >= f.params.longSwipesRatio ? b + f.params.slidesPerGroup : b), "prev" === f.swipeDirection && f.slideTo(E > 1 - f.params.longSwipesRatio ? b + f.params.slidesPerGroup : b)
					} else {
						if (!f.params.shortSwipes) return void f.slideTo(f.activeIndex);
						"next" === f.swipeDirection && f.slideTo(b + f.params.slidesPerGroup), "prev" === f.swipeDirection && f.slideTo(b)
					}
				}
			}, f._slideTo = function(e, t) {
				return f.slideTo(e, t, !0, !0)
			}, f.slideTo = function(e, t, a, i) {
				"undefined" == typeof a && (a = !0), "undefined" == typeof e && (e = 0), 0 > e && (e = 0), f.snapIndex = Math.floor(e / f.params.slidesPerGroup), f.snapIndex >= f.snapGrid.length && (f.snapIndex = f.snapGrid.length - 1);
				var s = -f.snapGrid[f.snapIndex];
				f.params.autoplay && f.autoplaying && (i || !f.params.autoplayDisableOnInteraction ? f.pauseAutoplay(t) : f.stopAutoplay()), f.updateProgress(s);
				for (var n = 0; n < f.slidesGrid.length; n++) - s >= f.slidesGrid[n] && (e = n);
				if ("undefined" == typeof t && (t = f.params.speed), f.previousIndex = f.activeIndex || 0, f.activeIndex = e, s === f.translate) return f.updateClasses(), !1;
				f.onTransitionStart(a);
				r() ? s : 0, r() ? 0 : s;
				return 0 === t ? (f.setWrapperTransition(0), f.setWrapperTranslate(s), f.onTransitionEnd(a)) : (f.setWrapperTransition(t), f.setWrapperTranslate(s), f.animating || (f.animating = !0, f.wrapper.transitionEnd(function() {
					f.onTransitionEnd(a)
				}))), f.updateClasses(), !0
				...
				var i = 0,
					s = 0,
					n = 0;
				r() ? i = f.rtl ? -e : e : s = e, f.params.virtualTranslate || f.wrapper.transform(f.support.transforms3d ? "translate3d(" + i + "px, " + s + "px, " + n + "px)" : "translate(" + i + "px, " + s + "px)"), f.translate = r() ? i : s, t && f.updateActiveIndex(), "slide" !== f.params.effect && f.effects[f.params.effect] && f.effects[f.params.effect].setTranslate(f.translate), f.params.parallax && f.parallax && f.parallax.setTranslate(f.translate), f.params.scrollbar && f.scrollbar && f.scrollbar.setTranslate(f.translate), f.params.control && f.controller && f.controller.setTranslate(f.translate, a), f.emit("onSetTranslate", f, f.translate)
				...
				return "undefined" == typeof e && (e = r() ? "x" : "y"), f.getTranslate(f.wrapper[0], e)
			}, f.observers = [], f.initObservers = function() {
				if (f.params.observeParents) for (var e = f.container.parents(), t = 0; t < e.length; t++) n(e[t]);
				n(f.container[0], {
					childList: !1
				}), n(f.wrapper[0], {
					attributes: !1
				...
				for (e.each(function(t, i) {
					var s = h(this);
					t < f.loopedSlides && r.push(i), t < e.length && t >= e.length - f.loopedSlides && a.push(i), s.attr("data-swiper-slide-index", t)
				}), t = 0; t < r.length; t++) f.wrapper.append(h(r[t].cloneNode(!0)).addClass(f.params.slideDuplicateClass));
				for (t = a.length - 1; t >= 0; t--) f.wrapper.prepend(h(a[t].cloneNode(!0)).addClass(f.params.slideDuplicateClass))
				...
				if (f.params.loop && f.destroyLoop(), "object" == typeof e && e.length) for (var t = 0; t < e.length; t++) e[t] && f.wrapper.append(e[t]);
				...
				f.params.loop && f.destroyLoop();
				var t, a = f.activeIndex;
				if ("object" == typeof e && e.length) {
					for (var r = 0; r < e.length; r++) t = e[r], f.slides[t] && f.slides.eq(t).remove(), a > t && a--;
					a = Math.max(a, 0)
				} else t = e, f.slides[t] && f.slides.eq(t).remove(), a > t && a--, a = Math.max(a, 0);
				f.params.observer && f.support.observer || f.update(!0), f.slideTo(a, 0, !1)
				...
				fade: {
					setTranslate: function() {
						for (var e = 0; e < f.slides.length; e++) {
							...
							var s = 0;
							r() || (s = i, i = 0);
							var n = f.params.fade.crossFade ? Math.max(1 - Math.abs(t[0].progress), 0) : 1 + Math.min(Math.max(t[0].progress, -1), 0);
							t.css({
								opacity: n
					...
					setTranslate: function() {
						...
						for (var a = 0; a < f.slides.length; a++) {
							...
							var o = Math.max(Math.min(i[0].progress, 1), -1),
								...
								d = 0,
								p = 0;
							a % 4 === 0 ? (l = 4 * -n * f.size, p = 0) : (a - 1) % 4 === 0 ? (l = 0, p = 4 * -n * f.size) : (a - 2) % 4 === 0 ? (l = f.size + 4 * n * f.size, p = f.size) : (a - 3) % 4 === 0 && (l = -f.size, p = 3 * f.size + 4 * f.size * n), f.rtl && (l = -l), r() || (d = l, l = 0);
							var u = "rotateX(" + (r() ? 0 : -s) + "deg) rotateY(" + (r() ? s : 0) + "deg) translate3d(" + l + "px, " + d + "px, " + p + "px)";
							if (1 >= o && o > -1 && (t = 90 * a + 90 * o, f.rtl && (t = 90 * -a - 90 * o)), i.transform(u), f.params.cube.slideShadows) {
								var c = i.find(r() ? ".swiper-slide-shadow-left" : ".swiper-slide-shadow-top"),
									m = i.find(r() ? ".swiper-slide-shadow-right" : ".swiper-slide-shadow-bottom");
								0 === c.length && (c = h('<div class="swiper-slide-shadow-' + (r() ? "left" : "top") + '"></div>'), i.append(c)), 0 === m.length && (m = h('<div class="swiper-slide-shadow-' + (r() ? "right" : "bottom") + '"></div>'), i.append(m)); {
									i[0].progress
								}
								c.length && (c[0].style.opacity = -i[0].progress), m.length && (m[0].style.opacity = i[0].progress)
							}
						}
						if (f.wrapper.css({
						...
						}), f.params.cube.shadow) if (r()) e.transform("translate3d(0px, " + (f.width / 2 + f.params.cube.shadowOffset) + "px, " + -f.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + f.params.cube.shadowScale + ")");
						else {
							...
							e.transform("scale3d(" + w + ", 1, " + y + ") translate3d(0px, " + (f.height / 2 + b) + "px, " + -f.height / 2 / y + "px) rotateX(-90deg)")
						}
						var T = f.isSafari || f.isUiWebView ? -f.size / 2 : 0;
						f.wrapper.transform("translate3d(0px,0," + T + "px) rotateX(" + (r() ? 0 : t) + "deg) rotateY(" + (r() ? -t : 0) + "deg)")
					},
					setTransition: function(e) {
				...
				coverflow: {
					setTranslate: function() {
						for (var e = f.translate, t = r() ? -e + f.width / 2 : -e + f.height / 2, a = r() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, i = f.params.coverflow.depth, s = 0, n = f.slides.length; n > s; s++) {
							var o = f.slides.eq(s),
							...
							if (o.transform(w), o[0].style.zIndex = -Math.abs(Math.round(p)) + 1, f.params.coverflow.slideShadows) {
								...
								0 === y.length && (y = h('<div class="swiper-slide-shadow-' + (r() ? "left" : "top") + '"></div>'), o.append(y)), 0 === b.length && (b = h('<div class="swiper-slide-shadow-' + (r() ? "right" : "bottom") + '"></div>'), o.append(b)), y.length && (y[0].style.opacity = p > 0 ? p : 0), b.length && (b[0].style.opacity = -p > 0 ? -p : 0)
							}
						}
						if (f.browser.ie) {
				...
				set: function() {
					if (f.params.scrollbar) {
						var e = f.scrollbar;
						e.track = h(f.params.scrollbar), e.drag = e.track.find(".swiper-scrollbar-drag"), 0 === e.drag.length && (e.drag = h('<div class="swiper-scrollbar-drag"></div>'), e.track.append(e.drag)), e.drag[0].style.width = "", e.drag[0].style.height = "", e.trackSize = r() ? e.track[0].offsetWidth : e.track[0].offsetHeight, e.divider = f.size / f.virtualSize, e.moveDivider = e.divider * (e.trackSize / f.size), e.dragSize = e.trackSize * e.divider, r() ? e.drag[0].style.width = e.dragSize + "px" : e.drag[0].style.height = e.dragSize + "px", e.track[0].style.display = e.divider >= 1 ? "none" : "", f.params.scrollbarHide && (e.track[0].style.opacity = 0)
					}
				},
				setTranslate: function() {
					if (f.params.scrollbar) {
						...
						e = (t.trackSize - t.dragSize) * f.progress, f.rtl && r() ? (e = -e, e > 0 ? (a = t.dragSize - e, e = 0) : -e + t.dragSize > t.trackSize && (a = t.trackSize + e)) : 0 > e ? (a = t.dragSize + e, e = 0) : e + t.dragSize > t.trackSize && (a = t.trackSize - e), r() ? (t.drag.transform(f.support.transforms3d ? "translate3d(" + e + "px, 0, 0)" : "translateX(" + e + "px)"), t.drag[0].style.width = a + "px") : (t.drag.transform(f.support.transforms3d ? "translate3d(0px, " + e + "px, 0)" : "translateY(" + e + "px)"), t.drag[0].style.height = a + "px"), f.params.scrollbarHide && (clearTimeout(t.timeout), t.track[0].style.opacity = 1, t.timeout = setTimeout(function() {
				...
				setTranslate: function(e, t) {
					var a, r, i = f.params.control;
					if (f.isArray(i)) for (var s = 0; s < i.length; s++) i[s] !== t && i[s] instanceof Swiper && (e = i[s].rtl && "horizontal" === i[s].params.direction ? -f.translate : f.translate, a = (i[s].maxTranslate() - i[s].minTranslate()) / (f.maxTranslate() - f.minTranslate()), r = (e - f.minTranslate()) * a + i[s].minTranslate(), f.params.controlInverse && (r = i[s].maxTranslate() - r), i[s].updateProgress(r), i[s].setWrapperTranslate(r, !1, f), i[s].updateActiveIndex());
					else i instanceof Swiper && t !== i && (e = i.rtl && "horizontal" === i.params.direction ? -f.translate : f.translate, a = (i.maxTranslate() - i.minTranslate()) / (f.maxTranslate() - f.minTranslate()), r = (e - f.minTranslate()) * a + i.minTranslate(), f.params.controlInverse && (r = i.maxTranslate() - r), i.updateProgress(r), i.setWrapperTranslate(r, !1, f), i.updateActiveIndex())
				},
				setTransition: function(e, t) {
					var a = f.params.control;
					if (f.isArray(a)) for (var r = 0; r < a.length; r++) a[r] !== t && a[r] instanceof Swiper && a[r].setWrapperTransition(e, f);
				...
				init: function() {
					if (f.params.hashnav) {
						...
						if (e) for (var t = 0, a = 0, r = f.slides.length; r > a; a++) {
							var i = f.slides.eq(a),
								s = i.attr("data-hash");
			...
			return f.callPlugins = function(e) {
				...
				var t;
				if (f.emitterEventListeners[e]) for (t = 0; t < f.emitterEventListeners[e].length; t++) f.emitterEventListeners[e][t](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
				f.callPlugins && f.callPlugins(e, arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
			}, f.on = function(e, t) {
				return e = p(e), f.emitterEventListeners[e] || (f.emitterEventListeners[e] = []), f.emitterEventListeners[e].push(t), f
			}, f.off = function(e, t) {
				var a;
				if (e = p(e), "undefined" == typeof t) return f.emitterEventListeners[e] = [], f;
				if (f.emitterEventListeners[e] && 0 !== f.emitterEventListeners[e].length) {
					for (a = 0; a < f.emitterEventListeners[e].length; a++) f.emitterEventListeners[e][a] === t && f.emitterEventListeners[e].splice(a, 1);
					return f
				}
			}, f.once = function(e, t) {
				e = p(e);
				var a = function() {
						t(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4]), f.off(e, a)
					};
				return f.on(e, a), f
			}, f.a11y = {
				...
				init: function() {
					...
					if (f.params.prevButton) {
						...
						f.a11y.makeFocusable(t), f.a11y.addRole(t, "button"), f.a11y.addLabel(t, f.params.prevSlideMsg)
					}
	...
	for (var t = (function() {
		var e = function(e) {
			...
			t = function(t, a) {
				...
				if (t) if ("string" == typeof t) {
					...
					} else for (s = a || "#" !== t[0] || t.match(/[ .<>:~]/) ? (a || document).querySelectorAll(t) : [document.getElementById(t.split("#")[1])], i = 0; i < s.length; i++) s[i] && r.push(s[i])
		...
		return e.prototype = {
			...
			attr: function(e, t) {
				...
				else for (var r in e) this[a][r] = e[r], this[a].setAttribute(r, e[r]);
				return this
			},
			...
			on: function(e, a, r, i) {
				...
				var n, o, l = e.split(" ");
				for (n = 0; n < this.length; n++) if ("function" == typeof a || a === !1) for ("function" == typeof a && (r = arguments[1], i = arguments[2] || !1), o = 0; o < l.length; o++) this[n].addEventListener(l[o], r, i);
			...
			off: function(e, t, a, r) {
				for (var i = e.split(" "), s = 0; s < i.length; s++) for (var n = 0; n < this.length; n++) if ("function" == typeof t || t === !1)"function" == typeof t && (a = arguments[1], r = arguments[2] || !1), this[n].removeEventListener(i[s], a, r);
			...
			is: function(a) {
				...
				if ("string" == typeof a) {
					...
					for (r = t(a), i = 0; i < r.length; i++) if (r[i] === this[0]) return !0;
					return !1
				}
				if (a === document) return this[0] === document;
				if (a === window) return this[0] === window;
				if (a.nodeType || a instanceof e) {
					for (r = a.nodeType ? [a] : a, i = 0; i < r.length; i++) if (r[i] === this[0]) return !0;
					return !1
				}
				return !1
			},
			...
			append: function(t) {
				...
				} else if (t instanceof e) for (r = 0; r < t.length; r++) this[a].appendChild(t[r]);
			...
			prepend: function(t) {
				...
				} else if (t instanceof e) for (r = 0; r < t.length; r++) this[a].insertBefore(t[r], this[a].childNodes[0]);
			...
			parents: function(e) {
				for (var a = [], r = 0; r < this.length; r++) for (var i = this[r].parentNode; i;) e ? t(i).is(e) && a.push(i) : a.push(i), i = i.parentNode;
				return t(t.unique(a))
			},
			find: function(t) {
